...
var id = "greek_incremental";
var name = "My Custom Theory";
var description = "This Aplha Generators, Not a Beta, shuch, not ever? \nEven This Get Aplha not a layers. \never do Omega Layers this all layers from generators for everyone!";
var authors = "Karen";
var version = 1;
...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency, new ExponentialCost(1e5, Math.log2(10)));
    ...
    achievement3 = theory.createSecretAchievement(2, "Achievement 3", "Description 3", "Maybe you should buy three levels of c2?", () => c2.level > 2);
